	 ...
	 <div class="wrap">
	    ...
	    <div class="cssmenu">
		   <ul>
			 ...
			 <li><a href="${pageContext.servletContext.contextPath}/shop">Store Locator</a></li>
				  ...
				  <article style="position: relative; width: 100%; opacity: 1;">
				   	<div class="banner-wrap">
					   	<div class="slider-left">
							<img src="static/resources/images/banner1.jpg" alt=""/>
						</div>
						 <div class="slider-right">
						    <h1>Classic</h1>
						    <h2>White</h2>
						    <p>Primero</p>
						    <div class="btn"><a href="${pageContext.servletContext.contextPath}/shop">Shop Now</a></div>
						 </div>
						 <div class="clear"></div>
					 </div>
					</article>
				   ...
				   <article style="position: absolute; width: 100%; opacity: 0;">
				   	 <div class="banner-wrap">
					   	<div class="slider-left">
							<img src="static/resources/images/banner2.jpg" alt=""/>
						</div>
						 <div class="slider-right">
						    <h1>Classic</h1>
						    <h2>White</h2>
             ...
             <div class="clear"></div>
                ...
                -->
                 ...
                 <ul class="wmuSliderPagination">
                    ...
                    <!-- Bucle según en número de slides
                     <li><a href="#" class="">1</a></li>
       ...
       <!--
             	  <div class="content-top">
					...
					<div class="cont span_2_of_c1">
					  <div class="social">
					     <ul>
						  <li class="facebook"><a href="#"><span> </span></a><div class="radius"> <img src="static/resources/images/radius.png"><a href="#"> </a></div><div class="border hide"><p class="num">1.51K</p></div></li>
						 </ul>
			   		   </div>
					   <div class="social">
						   <ul>
							  <li class="twitter"><a href="#"><span> </span></a><div class="radius"> <img src="static/resources/images/radius.png"></div><div class="border hide"><p class="num">1.51K</p></div></li>
						  </ul>
			     		</div>
						 <div class="social">
						   <ul>
							  <li class="google"><a href="#"><span> </span></a><div class="radius"> <img src="static/resources/images/radius.png"></div><div class="border hide"><p class="num">1.51K</p></div></li>
						   </ul>
			    		 </div>
						 <div class="social">
						   <ul>
							  <li class="dot"><a href="#"><span> </span></a><div class="radius"> <img src="static/resources/images/radius.png"></div><div class="border hide"><p class="num">1.51K</p></div></li>
						  </ul>
			     		</div>
						<div class="clear"> </div>
					  </div>
				    ...
				    <div class="col_1_of_3 span_1_of_3"><a href="single.html">
				     <div class="view view-fifth">
				  	  <div class="top_box">
				         ...
				         <div class="grid_img">
						   <div class="css3"><img src="static/resources/images/pic.jpg" alt=""/></div>
					          <div class="mask">
				    ...
				    <div class="col_1_of_3 span_1_of_3"><a href="single.html">
				     <div class="view view-fifth">
				  	  <div class="top_box">
					  	...
					  	<p class="m_2">Lorem ipsum</p>
					    <div class="grid_img">
						   <div class="css3"><img src="static/resources/images/pic1.jpg" alt=""/></div>
					          <div class="mask">
	                       		<div class="info">Quick View</div>
			                  </div>
	                    </div>
				    ...
				    <div class="col_1_of_3 span_1_of_3"><a href="single.html">
				     <div class="view view-fifth">
				  	  <div class="top_box">
					  	...
					  	<p class="m_2">Lorem ipsum</p>
				         <div class="grid_img">
						   <div class="css3"><img src="static/resources/images/pic2.jpg" alt=""/></div>
					          <div class="mask">
	                       		<div class="info">Quick View</div>
			                  </div>
	                    </div>
				  ...
				  <div class="col_1_of_3 span_1_of_3"><a href="single.html">
				     <div class="view view-fifth">
				  	  <div class="top_box">
					  	...
					  	<p class="m_2">Lorem ipsum</p>
				         <div class="grid_img">
						   <div class="css3"><img src="static/resources/images/pic3.jpg" alt=""/></div>
					          <div class="mask">
	                       		<div class="info">Quick View</div>
			                  </div>
	                    </div>
				    ...
				    <div class="col_1_of_3 span_1_of_3"><a href="single.html">
				     <div class="view view-fifth">
				  	  <div class="top_box">
					  	...
					  	<p class="m_2">Lorem ipsum</p>
				         <div class="grid_img">
						   <div class="css3"><img src="static/resources/images/pic4.jpg" alt=""/></div>
					          <div class="mask">
	                       		<div class="info">Quick View</div>
			                  </div>
	                    </div>
				   ...
				   <div class="col_1_of_3 span_1_of_3"><a href="single.html">
				     <div class="view view-fifth">
				  	  <div class="top_box">
					  	...
					  	<p class="m_2">Lorem ipsum</p>
				         <div class="grid_img">
						   <div class="css3"><img src="static/resources/images/pic5.jpg" alt=""/></div>
					          <div class="mask">
	                       		<div class="info">Quick View</div>
			                  </div>
	                    </div>
       	  ...
       	  <div class="footer-top">
       		<div class="wrap">
       			   <div class="col_1_of_footer-top span_1_of_footer-top">
				  	 <ul class="f_list">
				  	 	<li><img src="static/resources/images/f_icon.png" alt=""/><span class="delivery">Free delivery on all orders over £100*</span></li>
				  	 </ul>
				   </div>
				   <div class="col_1_of_footer-top span_1_of_footer-top">
				  	<ul class="f_list">
				  	 	<li><img src="static/resources/images/f_icon1.png" alt=""/><span class="delivery">Customer Service :<span class="orange"> (800) 000-2587 (freephone)</span></span></li>
				  	 </ul>
				   </div>
				   <div class="col_1_of_footer-top span_1_of_footer-top">
				  	<ul class="f_list">
				  	 	<li><img src="static/resources/images/f_icon2.png" alt=""/><span class="delivery">Fast delivery & free returns</span></li>
				  	 </ul>
				   </div>
				  <div class="clear"></div>
			 </div>
